...
! function(t, e) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.drawQrcode = e()
}(this, function() {
  "use strict";
  ...
  t.prototype = {
    ...
    setupTypeInfo: function(t, e) {
      for (var r = this.errorCorrectLevel << 3 | e, n = g.getBCHTypeInfo(r), o = 0; o < 15; o++) {
        var i = !t && 1 == (n >> o & 1);
        ...
        for (6 == a && a--;;) {
          for (var s = 0; s < 2; s++)
            if (null == this.modules[n][a - s]) {
              var u = !1;
              i < t.length && (u = 1 == (t[i] >>> o & 1)), g.getMask(e, n, a - s) && (u = !u), this.modules[n][a - s] = u, -1 == --o && (i++, o = 7)
            }
    ...
    for (var o = v.getRSBlocks(t, r), i = new C, a = 0; a < n.length; a++) {
      var s = n[a];
      i.put(s.mode, 4), i.put(s.getLength(), g.getLengthInBits(s.mode, t)), s.write(i)
    }
    var u = 0;
    ...
    for (var r = 0, n = 0, o = 0, i = new Array(e.length), a = new Array(e.length), s = 0; s < e.length; s++) {
      ...
      r += u;
      var f = g.getErrorCorrectPolynomial(h),
        c = new m(i[s], f.getLength() - 1).mod(f);
      a[s] = new Array(f.getLength() - 1);
      for (l = 0; l < a[s].length; l++) {
        var d = l + c.getLength() - a[s].length;
        a[s][l] = d >= 0 ? c.get(d) : 0
      }
    }
    var v = 0;
    ...
    var C = new Array(v),
      p = 0;
    for (l = 0; l < n; l++)
      for (s = 0; s < e.length; s++) l < i[s].length && (C[p++] = i[s][l]);
    for (l = 0; l < o; l++)
      for (s = 0; s < e.length; s++) l < a[s].length && (C[p++] = a[s][l]);
    return C
  };
  for (var r = {
      MODE_NUMBER: 1,
      ...
      Q: 3,
      H: 2
    }, o = 0, i = 1, a = 2, s = 3, u = 4, h = 5, l = 6, f = 7, g = {
      ...
      getErrorCorrectPolynomial: function(t) {
        for (var e = new m([1], 0), r = 0; r < t; r++) e = e.multiply(new m([1, c.gexp(r)], 0));
        return e
      },
    ...
    }, d = 0; d < 8; d++) c.EXP_TABLE[d] = 1 << d;
  for (d = 8; d < 256; d++) c.EXP_TABLE[d] = c.EXP_TABLE[d - 4] ^ c.EXP_TABLE[d - 5] ^ c.EXP_TABLE[d - 6] ^ c.EXP_TABLE[d - 8];
  for (d = 0; d < 255; d++) c.LOG_TABLE[c.EXP_TABLE[d]] = d;
  ...
  return m.prototype = {
      ...
      mod: function(t) {
        ...
        for (var e = c.glog(this.get(0)) - c.glog(t.get(0)), r = new Array(this.getLength()), n = 0; n < this.getLength(); n++) r[n] = this.get(n);
        for (n = 0; n < t.getLength(); n++) r[n] ^= c.gexp(c.glog(t.get(n)) + e);
      ...
      for (var n = r.length / 3, o = new Array, i = 0; i < n; i++)
        for (var a = r[3 * i + 0], s = r[3 * i + 1], u = r[3 * i + 2], h = 0; h < a; h++) o.push(new v(s, u));
      return o
    ...
    function(t) {
      t = t || {}, (t = Object.assign({
        ...
        r.addData(t.text), r.make();
        for (var n = t._this ? wx.createCanvasContext && wx.createCanvasContext(t.canvasId, t._this) : wx.createCanvasContext && wx.createCanvasContext(t.canvasId), o = t.width / r.getModuleCount(), i = t.height / r.getModuleCount(), a = 0; a < r.getModuleCount(); a++)
          for (var s = 0; s < r.getModuleCount(); s++) {
            var u = r.isDark(a, s) ? t.foreground : t.background;
            n.setFillStyle(u);
            var h = Math.ceil((s + 1) * o) - Math.floor(s * o),
