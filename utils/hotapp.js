! function() {
    ...
    wx.login({
      success: function(n) {
        return n.code ? void wx.request({
          ...
          success: function(t) {
            var n = t.data.openid;
            return l.isEmpty(n) && (n = g.getFakeOpenID()), g.setOpenID(n), "function" == typeof e && e(n)
          },
          fail: t
        }) : t()
      },
  ...
  function o(e) {
    void 0 === e && (e = A);
    var t = "hotAppKey不能为空";
    if (l.isEmpty(e)) throw wx.showToast({
      title: t
    }), Error(t)
  }
  ...
  function a() {
    wx.request({
      ...
      success: function(e) {
        ...
        if (0 == t) g.set("uploadType", e.data.upload_type);
        else {
  ...
  var l = function() {
      ...
      var o = Object.prototype.toString,
        ...
        i = function(e, t) {
          if (p.isObject(e))
            for (var n in e) r.call(e, n) && t.call(null, n, e[n]);
          else if (p.isArray(e))
            for (var o = 0, a = e.length; o < a; o++) t.call(null, e[o], o)
        };
      return {
        assert: p,
        inArray: e,
  ...
  Page = function(e) {
    h(e, "onReady", function() {}), h(e, "onLoad", function() {
      var e = arguments[0];
      c(this, e)
    }), h(e, "onUnload", function() {}), h(e, "onShow", function() {
      d("page show")
    }), h(e, "onHide", function() {
      d("page hide")
